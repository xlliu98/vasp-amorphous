...
def extract_energies(scales, optDir="quench_and_opt", log_file="e0_relaxed.log"):
    cwd = os.getcwd()
    os.chdir(optDir)
...
extract_energies(scales, optDir="quench_and_opt", log_file="e0_relaxed.log")
scales, energies = get_e_from_log(file_path="quench_and_opt/e0_relaxed.log")
